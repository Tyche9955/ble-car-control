...
class ScanScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: car.isConnected ? ControlScreen() : _buildScanBody(context, car),
    );
  }

  Widget _buildScanBody(BuildContext context, CarManager car) {
    return Column(children: [
      Container(color: Color(0xFF1F1F1F), padding: EdgeInsets.all(16),
        child: Column(children: [
          ...
          Container(padding:EdgeInsets.all(12),
            decoration: BoxDecoration(color:Color(0xFF2D2D2D), borderRadius:BorderRadius.circular(10)),
      ...
      Expanded(child: car.devices.isEmpty
        ...
        : ListView.separated(
          ...
          separatorBuilder:(_,_) => Divider(height:1, color:Color(0xFF2D2D2D)),
          itemBuilder:(ctx,i){
